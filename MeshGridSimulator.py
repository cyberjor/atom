...
def solve(load_W, I_local):
    ...
    # Enforce 2kW power cap for all inverters
    for i in range(N):
        V = V_nodes[i]
        I = I_local[i]
        if I * V > CAP_W:
